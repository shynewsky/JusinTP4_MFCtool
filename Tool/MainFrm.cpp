...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	// CreateStatic : 분할된 창을 만들기위한 함수
	// CreateStatic(부모 윈도우 주소, 행의 수, 열의 수, 창 스타일 옵션, 자식창 ID)
	...
	// IdFromRowCol(행, 열) : 지정한 행과 열에 해당하는 창의 ID값을 얻어옴
	...
	//SetColumnInfo(열 번호, 열의 크기 지정, 최소 허용 크기)
